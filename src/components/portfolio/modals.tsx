      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 28, flexWrap: 'wrap' }}>
            {project.live && <button type="button" className="btn btn-alt">Live site <span>↗</span></button>}
            {project.repo && <button type="button" className="btn btn-ghost">GitHub <span>↗</span></button>}
            {project.itch && <button type="button" className="btn btn-lime">Play on itch.io <span>↗</span></button>}
          </div>
        </div>
      </div>
    </div>
